...
local lock = ipc .. "lockScreen lock"
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(eb6f92ee)", "rgba(ebbcbaee)"}, angle = 45 },
            inactive_border = "rgba(31748faa)",
        },
...
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd("pypr hide \"*\""))
...
hl.window_rule({ match = { class = "foot-kew" }, float = true })
hl.window_rule({ match = { class = "foot-yazi" }, float = true })
hl.window_rule({ match = { class = "foot-dropterm" }, float = true })
